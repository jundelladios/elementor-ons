...
$genstateid = get_post_meta(get_the_ID(), 'generator_stateid', true);
...
$stateParams = [
	...
	'withsettings' => 1,
	'withstatecounties' => 1,
	'with_county_settings' => 1,
	'slug' => $post->post_name,
	'domain' => $gendomain
];

if($genstateid) {
	$stateParams['state_id'] = $genstateid;
}

$remoteStateURL = carbon_get_theme_option('portal_admin') . '/api/v1/counties?' . http_build_query($stateParams);
$requestStateAPI = wp_remote_get($remoteStateURL); 
$county = json_decode( wp_remote_retrieve_body( $requestStateAPI ) );
$county = $county[0];

$theState = $county->state;
$countySettings = $county->state->county_settings;
$stateSettings = $county->state->settings;
$counties = $county->state->counties;
...
$cssAssets = [
	[
		'id' => 'auto-generate-county',
		'href' => "$directoryURI/auto-generate-county/style.css?ver=$themeVersion"
	],
	[
		'id' => 'auto-generate-county-mobile',
		'href' => "$directoryURI/auto-generate-county/style-mobile.css?ver=$themeVersion"
	],
	// [
	// 	'id' => 'auto-generate-county-font',
	// 	'href' => "$directoryURI/auto-generate-county/font.css?ver=$themeVersion"
	// ],
	[
		'id' => 'auto-generate-county-slick',
		'href' => "$directoryURI/auto-generate-county/slick/slick.css?ver=$themeVersion"
	],
	[
		'id' => 'auto-generate-county-slick-theme',
		'href' => "$directoryURI/auto-generate-county/slick/slick-theme.css?ver=$themeVersion"
	],
	[
		'id' => 'auto-generate-county-fancybox',
		'href' => "$directoryURI/auto-generate-county/fancybox.css?ver=$themeVersion"
	]
];
...
$jsAssets = [
	[
		'id' => 'auto-generate-county-slick',
		'href' => "$directoryURI/auto-generate-county/slick/slick.min.js?ver=$themeVersion"
	],
	[
		'id' => 'auto-generate-county-fancybox',
		'href' => "$directoryURI/auto-generate-county/fancybox.js?ver=$themeVersion"
	],
	[
		'id' => 'auto-generate-county',
		'href' => "$directoryURI/auto-generate-county/script.js?ver=$themeVersion"
	]
];
...
function _ssgen_content($content) {
	...
	return _ssgen_contentFormat( [
		...
		'county-sanitized' => sanitize_title($county->sanitized_county)
	],$content);
